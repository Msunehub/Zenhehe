...
Settings.Image = "http://www.roblox.com/asset/?id=14479606771"
...
function functionitem:Paragraph(text)
local textas = {}
local Label = Instance.new("Frame")
local Text = Instance.new("TextLabel")
Label.Name = "Label"
...
Label.AnchorPoint = Vector2.new(0.5, 0.5)
Label.BackgroundTransparency = 1.000
Label.Size = UDim2.new(0, 230, 0, 15)
